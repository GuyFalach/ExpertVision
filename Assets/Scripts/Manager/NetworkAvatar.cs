...
{
    [SerializeField] private ulong m_instantiationData; 
    [SerializeField] int m_avatarToUseInZipFolder = 2; 
    private PhotonView m_photonView; 
    private List<byte[]> m_streamedDataList = new List<byte[]>(); 
    private int m_maxBytesToLog = 15; 
    private float m_cycleStartTime = 0; 
    private float m_intervalToSendData = 0.08f;
